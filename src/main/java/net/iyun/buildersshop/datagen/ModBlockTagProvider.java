...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(BlockTags.STAIRS)
                .add(ModBlocks.SMOOTH_DARK_OAK_STAIR)
                .add(ModBlocks.SMOOTH_OAK_STAIR)
                .add(ModBlocks.SMOOTH_BIRCH_STAIR)
                .add(ModBlocks.SMOOTH_ACA_STAIR)
                .add(ModBlocks.SMOOTH_CHERRY_STAIR)
                .add(ModBlocks.SMOOTH_CRIMSON_STAIR)
                .add(ModBlocks.SMOOTH_JUNGLE_STAIR)
                .add(ModBlocks.SMOOTH_MANGROVE_STAIR)
                .add(ModBlocks.SMOOTH_SPRUCE_STAIR)
                .add(ModBlocks.SMOOTH_WARPED_STAIR)
        ...
        getOrCreateTagBuilder(BlockTags.WOODEN_SLABS)
                ...
                .add(ModBlocks.SMOOTH_DARK_OAK_SLAB)
                .add(ModBlocks.SMOOTH_OAK_SLAB)
                .add(ModBlocks.SMOOTH_BIRCH_SLAB)
                .add(ModBlocks.SMOOTH_ACA_SLAB)
                .add(ModBlocks.SMOOTH_CHERRY_SLAB)
                .add(ModBlocks.SMOOTH_CRIMSON_SLAB)
                .add(ModBlocks.SMOOTH_JUNGLE_SLAB)
                .add(ModBlocks.SMOOTH_MANGROVE_SLAB)
                .add(ModBlocks.SMOOTH_SPRUCE_SLAB)
                .add(ModBlocks.SMOOTH_WARPED_SLAB)
        ...
        getOrCreateTagBuilder(BlockTags.AXE_MINEABLE)
                ...
                .add(ModBlocks.SMOOTH_BIRCH_STAIR)
                .add(ModBlocks.SMOOTH_BIRCH_V_SLAB)
                .add(ModBlocks.SMOOTH_BIRCH_SLAB)
                .add(ModBlocks.SMOOTH_OAK)
                .add(ModBlocks.SMOOTH_OAK_STAIR)
                .add(ModBlocks.SMOOTH_OAK_V_SLAB)
                .add(ModBlocks.SMOOTH_OAK_SLAB)
                .add(ModBlocks.SMOOTH_DARK_OAK)
                .add(ModBlocks.SMOOTH_DARK_OAK_STAIR)
                .add(ModBlocks.SMOOTH_DARK_OAK_V_SLAB)
                .add(ModBlocks.SMOOTH_DARK_OAK_SLAB)
                .add(ModBlocks.SMOOTH_ACA)
                .add(ModBlocks.SMOOTH_ACA_STAIR)
                .add(ModBlocks.SMOOTH_ACA_V_SLAB)
                .add(ModBlocks.SMOOTH_ACA_SLAB)
                .add(ModBlocks.SMOOTH_CHERRY)
                .add(ModBlocks.SMOOTH_CHERRY_STAIR)
                .add(ModBlocks.SMOOTH_CHERRY_V_SLAB)
                .add(ModBlocks.SMOOTH_CHERRY_SLAB)
                .add(ModBlocks.SMOOTH_CRIMSON)
                .add(ModBlocks.SMOOTH_CRIMSON_STAIR)
                .add(ModBlocks.SMOOTH_CRIMSON_V_SLAB)
                .add(ModBlocks.SMOOTH_CRIMSON_SLAB)
                .add(ModBlocks.SMOOTH_JUNGLE)
                .add(ModBlocks.SMOOTH_JUNGLE_STAIR)
                .add(ModBlocks.SMOOTH_JUNGLE_V_SLAB)
                .add(ModBlocks.SMOOTH_JUNGLE_SLAB)
                .add(ModBlocks.SMOOTH_MANGROVE)
                .add(ModBlocks.SMOOTH_MANGROVE_STAIR)
                .add(ModBlocks.SMOOTH_MANGROVE_V_SLAB)
                .add(ModBlocks.SMOOTH_MANGROVE_SLAB)
                .add(ModBlocks.SMOOTH_SPRUCE)
                .add(ModBlocks.SMOOTH_SPRUCE_STAIR)
                .add(ModBlocks.SMOOTH_SPRUCE_V_SLAB)
                .add(ModBlocks.SMOOTH_SPRUCE_SLAB)
                .add(ModBlocks.SMOOTH_WARPED)
                .add(ModBlocks.SMOOTH_WARPED_STAIR)
                .add(ModBlocks.SMOOTH_WARPED_V_SLAB)
                .add(ModBlocks.SMOOTH_WARPED_SLAB)
                .add(ModBlocks.VERTICAL_OAK_PLANK_SLAB);
